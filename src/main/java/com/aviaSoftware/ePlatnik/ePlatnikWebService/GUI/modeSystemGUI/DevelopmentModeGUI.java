...
public class DevelopmentModeGUI extends JFrame implements ActionListener{
	private JLabel label;
	private JButton backButton;
	
	public DevelopmentModeGUI() {
		...
		//tworzenie etykiety
		label = new JLabel();
		label.setText("Tryb pracy: Development");
